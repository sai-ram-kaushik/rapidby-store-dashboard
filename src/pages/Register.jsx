  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_APP_API_ENDPOINT}/api/store/create-store-admin`,
        formData,
        {
          headers: {
      ...
      console.log("User Registered Successfully!! Admin will approve your profile soon", response.data);
      toast.success("User Registered Successfully!! Admin will approve your profile soon");
      navigate("/");
    } catch (error) {
